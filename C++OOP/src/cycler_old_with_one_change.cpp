...
// Mars to Mars
    ...
    //Candidate Vinf
    vec VinfM31 = vinf(V34[0], vMars);
    vec VinfM32 = vinf(V34pri[0], vMars);

    vMars.x = Vm3(0); vMars.y = Vm3(1); vMars.z = Vm3(2);

    //Candidate Vinf
    vec VinfM41 = vinf(V34[1], vMars);
    vec VinfM42 = vinf(V34pri[1], vMars);
...
// Mars to Earth
    ...
    //Vinf vectors
    vec VinfM5 = vinf(V56[0], vMars);
    vec VinfE6 = vinf(V56[1], vEarth);
...
// Earth to Earth
    ...
    vec VinfE71 = vinf(V78[0], vEarth);
    vec VinfE72 = vinf(V78pri[0], vEarth);

    vEarth.x = state5E[1](0); vEarth.y = state5E[1](1); vEarth.z = state5E[1](2);

    vec VinfE81 = vinf(V78[1], vEarth);
    vec VinfE82 = vinf(V78pri[1], vEarth);
